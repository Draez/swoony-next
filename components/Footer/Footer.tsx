...
const Footer: FC = () => {
    return (
        <footer className="bg-main-blue text-white p-8 py-24 w-full">
            <div className="container mx-auto">
                <div className="text-center mb-16 max-w-xl mx-auto">
                    <h3 className="text-2xl font-semibold mb-10">Nyt voit olla edelläkävijä ja liittyä ensimmäisinä uuden deitti-sovelluksen pariin!</h3>
